...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull BottomNavigationView bottomNavBar, @NonNull FloatingActionButton fabAddUserEntry,
      @NonNull View fragmentBottomGuide) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomeBinding((ConstraintLayout) rootView, bottomAppBar, bottomLayout,
          bottomNavBar, fabAddUserEntry, fragmentBottomGuide);
    }
